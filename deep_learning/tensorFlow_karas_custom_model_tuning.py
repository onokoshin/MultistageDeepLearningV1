...
from tensorflow.python.keras.layers import Dense, Flatten, GlobalAveragePooling2D, ZeroPadding2D, MaxPooling2D, Conv2D
from tensorflow.python.keras.layers import Dropout
from tensorflow.python.keras.applications.resnet50 import preprocess_input
from tensorflow.python.keras.preprocessing.image import ImageDataGenerator
from tensorflow.python.keras import optimizers, Model
...
testing_folder_dir = r"C:\Users\Koshin\PycharmProjects\mask_rcnn_car\mask_rcnn_damage_detection\resized_cropped_car_images_224\BumperDamage\test"


### Provide a name for the model that is going to be created
new_model_name = "bumper_damage_front_rear_021019_224pix_vgg19_00001.h5"
...
def transfer_learning_run():
    ...
    my_new_model = Model(vgg19.input, x)
